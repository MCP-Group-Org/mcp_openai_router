...
Клиент think-tool автоматически обнаруживает устаревшую сессию при рестарте think-сервиса и выполняет повторный handshake. Первый запрос после рестарта может занять дополнительное время (~таймаут соединения + время handshake).

Логи автоматического восстановления:
- `WARNING: think-tool вернул 400: sessionId=<old-id> ...` — обнаружена устаревшая сессия
- `INFO: Обнаружена устаревшая сессия think-tool, попытка автоматического восстановления` — начало процесса
- `INFO: Сброс состояния сессии think-tool: старый sessionId=<old-id>` — сброс состояния
- `INFO: Автоматическое восстановление сессии успешно: новый sessionId=<new-id>` — успешное восстановление

Механизм восстановления ограничен одной попыткой на вызов для предотвращения бесконечных циклов.
